        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <img src="{{ $firstPost->featured }}" alt="{{$firstPost->title}}">
                            <div class="overlay"></div>
                            <a href="{{ $firstPost->featured }}" class="link-image js-zoom-image">
                                <i class="seoicon-zoom"></i>
                            </a>
                            <a href="{{route('post.single',['slug'=>$firstPost->slug])}}" class="link-post">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="category">
                                            ...
                                            <a href="{{route('category.single',['id'=>$firstPost->category->id])}}">{{ $firstPost->category->name }}</a>
                                        </span>
        ...
        <div class="row">
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                        <img src="{{ $secondPost->featured }}" alt="{{$secondPost->title}}">
                            <div class="overlay"></div>
                            <a href="{{ $secondPost->featured }}" class="link-image js-zoom-image">
                                <i class="seoicon-zoom"></i>
                            </a>
                            <a href="{{route('post.single',['slug'=>$secondPost->slug])}}" class="link-post">
                                <i class="seoicon-link-bold"></i>
                            </a>
                        </div>
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <h2 class="post__title entry-title text-center">
                                        <a href="{{route('post.single',['slug'=>$secondPost->slug])}}">{{ $secondPost->title }}</a>
                                    </h2>
            ...
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                        <img src="{{ $thirdPost->featured }}" alt="{{$thirdPost->title}}">
                            <div class="overlay"></div>
                            <a href="{{ $thirdPost->featured }}" class="link-image js-zoom-image">
                                <i class="seoicon-zoom"></i>
                            </a>
                            <a href="{{route('post.single',['slug'=>$thirdPost->slug])}}" class="link-post">
                                <i class="seoicon-link-bold"></i>
                            </a>
                        </div>
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <h2 class="post__title entry-title text-center">
                                        <a href="{{route('post.single',['slug'=>$thirdPost->slug])}}">{{ $thirdPost->title }}</a>
                                    </h2>
                        ...
                        <div class="case-item-wrap">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                ...
                                <h6 class="case-item__title">
                                        <a href="{{route('post.single',['slug'=>$post->slug])}}" class="link-post">
                                                <i class="seoicon-link-bold"></i>
                                            </a>
        ...
        <div class="container">
            <div class="row">
                <div class="subscribe scrollme">
                    ...
                    <form class="subscribe-form" method="post" action="{{route('email_s')}}">
                        {{csrf_field()}}
